...
const AboutPage = () => {
  return (
    <>
      <Head>
        <title>About - Christina Yun | Frontend Developer | Toronto</title>
        <meta
          name='description'
      ...
      <div className='mx-auto min-h-screen max-w-5xl px-8 xl:px-0 py-9'>
        ...
        <h3 className='text-xl lg:text-2xl mb-16 dark:text-gray-light'>
          Hello, thank you for visiting my site. This is where I share my
          journey of becoming a frontend developer.
        </h3>
        ...
        <ContentCont emoji='🔥' title='What am I passionate about?'>
          <p className='paragraph'>
            I am amazed by how fast frontend technologies have evolved in the
            past year. I have witnessed an outpouring of new updates, tutorials,
            and articles on the internet. In keeping up with the latest industry
          ...
          <p className='paragraph'>
            ...
            impact. I also enjoy being surrounded by people who are just as
            eager to learn from me, as I am from them.
          </p>
        </ContentCont>
